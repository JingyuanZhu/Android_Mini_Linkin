...
import com.example.zhu.resumetest.util.PermissionUtils;
...
public class BasicInfoEditActivity extends EditBaseActivity<BasicInfo> {
    ...
    private static int REQ_CODE_PICK_IMAGE = 100;
    ...
    @Override
    protected void setupUIForEdit(@Nullable BasicInfo data) {
    ...
    @Override
    protected void saveAndEdit(@Nullable BasicInfo data) {
        if(data == null) {
            data = new BasicInfo();
        }
